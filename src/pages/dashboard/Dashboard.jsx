    ...
    return (
        <div>
                                        ...
                                        <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                            <form onSubmit={handleChangeName}>
                                                ...
                                                <div className="flex gap-3">
                                                    <button
                                                        type="submit"
                                                        className="text-white w-1/2 bg-primary-green border-0 py-2 px-8 focus:outline-none hover:bg-primary-green rounded-lg mt-4 text-lg"
                                                    >
                                                        Done
                                                    </button>
                                                    <button
                                                        onClick={closeModal}
                                                        type="reset"
                                                        className="text-primary-text w-1/2 bg-primary-bg2 border-2 border-primary-main py-2 px-8 focus:outline-none hover:bg-primary-green rounded-lg mt-4 text-lg"
                                                    >
                                                        Cancel
                                                    </button>
                                                </div>
            ...
            <div>
                ...
                <div className="text-4xl my-10">Recently added to-do list</div>
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            {isLoading ? <tr><td><span className="loading text-primary-green text-center block mx-auto loading-ring loading-lg"></span></td></tr> : data?.map((task, idx) => <TaskList idx={idx} task={task} key={task?._id}></TaskList>)}
                        </tbody>
                    </table>
                </div>
